...
export class VerVacunasComponent implements OnInit {
  ...
  constructor(private servicio:TratamientoService, private parametroUrl:ActivatedRoute, private servicioMascota: MascotaService, public navCtr:NavController) { }
  ...
  public pdf() {
    ...
    for (let i = 0; i < this.tratamientos.length; i++) {
      if (this.tratamientos[i].tipoTratamiento == 'Vacuna' && this.tratamientos[i].idMascota == this.idMascota) {
